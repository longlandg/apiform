...
if (isset($_POST["submit"])) {
    ...
    $titleForApiCall = strtolower($title);

    if ( array_filter($errors)) {
        //echo errors in form
    } else {
        try {
            makeApiCall($titleForApiCall, $firstName);
...
<div class="row">
    ...
    <div class="col-4">
        ...
        <div>
            <div class="green-text"><?php echo $messages["success"]; ?></div>
            <div class="red-text"><?php echo $messages["error"]; ?></div>
        </div>
    </div>
</div>
</body>
